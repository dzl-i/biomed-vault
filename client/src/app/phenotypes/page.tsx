      ...
      {validUser ? (
        <>
          ...
          <div className="flex flex-col w-full justify-center items-center pl-20">
            <p>This is BiomeData&apos;s phenotype dataset page</p>
            <p>If you can see this, congratulations! You are a valid user that has logged in. Enjoy!</p>
          </div>
        </>
      ) : (
        <div className="flex flex-col items-center justify-center w-full gap-4">
          <p>If you see this, you are not logged in yet. Please create an account or log in to view the phenotype dataset page :)</p>
