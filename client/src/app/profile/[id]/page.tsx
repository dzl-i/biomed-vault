      ...
      {validUser ? (
        <>
          ...
          <div className="flex flex-col w-full justify-center items-center pl-20">
            <p>This is BiomeData&apos;s researcher profile page</p>
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4">
          <p>If you see this, you are not logged in yet. Please create an account or log in to view the researcher profile page :)</p>
